...
export const AUDIO_SANCTUARY_SELECT =
  'id, slug, title, description, instructor_name, instructor_avatar_url, duration_minutes, price_in_cents, price_in_calma, image_url, audio_cover_art_url, is_audio_sanctuary, is_featured, audio_sanctuary_category, audio_credits, sanctuary_status, badge, usage_tip, what_to_expect, play_count, scheduled_at, created_at'
