...
function VisaMark() {
  return (
    <svg viewBox="0 0 48 16" className="h-4 w-auto text-neutral-300" aria-label="Visa">
      <text
        x="0"
        y="13"
        fill="currentColor"
...
function MastercardMark() {
  return (
    <svg viewBox="0 0 36 22" className="h-5 w-auto" aria-label="Mastercard">
      <circle cx="13" cy="11" r="9" fill="currentColor" className="text-neutral-400" />
      <circle cx="23" cy="11" r="9" fill="currentColor" className="text-neutral-200" opacity="0.9" />
    </svg>
  )
}
...
function ApplePayMark() {
  return (
    <svg viewBox="0 0 44 18" className="h-4 w-auto text-neutral-300" aria-label="Apple Pay">
      <path
        fill="currentColor"
...
function GooglePayMark() {
  return (
    <svg viewBox="0 0 52 18" className="h-4 w-auto text-neutral-300" aria-label="Google Pay">
